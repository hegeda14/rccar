...
\lstdefinestyle{xc}
{
	...
	keywords={void, unsigned, int, char, uint8_t, uint16_t, uint32_t, byte, while, for, foreach, if, else, return, switch, select, case, break, client, server, combinable, tile, on, core, par},
