...
\begin{figure}[!ht]
	\includegraphics[width=\textwidth]{content/images/xtimecomposerwindows.png}
...
\begin{figure}[!ht]
	\includegraphics[width=\textwidth]{content/images/plka.pdf}
...
Some text \\
%AppMonitor.sh CorePlacer.sh ProcessKill.sh
\subsection{What kind of information needed?}
Some text \\
...
\end{figure}
\subsubsection{lttng, perf with babeltrace, and TraceCompass}
Some text \\
\begin{figure}[!ht]
