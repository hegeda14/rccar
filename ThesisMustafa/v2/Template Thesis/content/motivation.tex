...
While each processes are constructed in the manner that is explained, the overall online evaluation is handled within the Touchscreen Display process, the process that is able to show utilization results. In the Touchscreen Display section, the details about these will be given.
...
%Now explain Scheduling section bari!!!
