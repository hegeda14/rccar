...
\chapter{Parallel Programming} \label{multicorechapter} 
...
\section{Developing Parallel Software} 
...
\end{figure}
\section{Evaluation of Parallel Software}
Some text will come here! \\
\section{Optimization of Parallel Software}
Some text will come here! \\
...
\end{figure}
Some text will come here! \\
\section{Theoretical Objectives and Related Work}
Some text will come here! \\

%%% CHAPTER Parallel Programming ------------------end----
%%% CHAPTER APP4MC Development Environment ----------begin----
\chapter{APP4MC Development Environment} \label{app4mcchapter}
\section{Introduction} %Motivation, why is it useful...
\section{Features} %include schema
\section{Modeling}
...
\newpage\lstinputlisting[caption=File format that contains overall
