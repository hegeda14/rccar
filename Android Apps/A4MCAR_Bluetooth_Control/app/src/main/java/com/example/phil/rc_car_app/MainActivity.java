...
public class MainActivity extends Activity {
    ...
    // SPP UUID service
    private static final UUID myUUID = UUID.fromString("00001101-0000-1000-8000-00805F9B34FB"); //YENISINI BUL!!!! ve JOYSTICK VERISINI DOGRU ISLE!!!
    //old working: "00001101-0000-1000-8000-00805F9B34FB"
    //6.1.1 0000110a-0000-1000-8000-00805f9b34fb
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        joystick.setOnMoveListener(new JoystickView.OnMoveListener() {
            @Override
            public void onMove(int anglex, int strength) {
                ...
                if(strength <= 9) {
                    if(strength == 0) {
                        ...
                        speed = strength;
                        formatter = new DecimalFormat("0" + strength);
                ...
                if (anglex <= 9)
                {
                    if (anglex == 0) {
                        ...
                        angle = anglex;
                        formatter = new DecimalFormat("0" + anglex);
