...
bash CorePlacer.sh burn_cycles_around25_1         1
bash CorePlacer.sh burn_cycles_around25_2         1
bash CorePlacer.sh burn_cycles_around25_3         1
bash CorePlacer.sh apache2                        1
