	...
	$(document).ready(function(){
		...
		$.ajax({        url: "core_usage_xmos.inc",
				...
				success: function (data) {
					...
					xmos_tile00 = [parseInt(myArray2[0],10),parseInt(myArray2[1],10),parseInt(myArray2[2],10),parseInt(myArray2[3],10),parseInt(myArray2[4],10),parseInt(myArray2[5],10),parseInt(myArray2[6],10),parseInt(myArray2[7],10)];
					xmos_tile11 = [parseInt(myArray2[8],10),parseInt(myArray2[9],10),parseInt(myArray2[10],10),parseInt(myArray2[11],10),parseInt(myArray2[12],10),parseInt(myArray2[13],10),parseInt(myArray2[14],10),parseInt(myArray2[15],10)];
					...
					//$("#distSensorReading").append(avgtile0);
				}
		});
        ...
        plot1 = $.jqplot('chartdiv', [raspberry, xmos_tile00 ,xmos_tile11], {
