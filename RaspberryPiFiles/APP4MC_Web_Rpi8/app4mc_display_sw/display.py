...
files_list=[]
files_list.append("/var/www/html/deadline_logger_ethernet_app_rpi.inc")
files_list.append("/var/www/html/deadline_logger_record_core_usage_rpi.inc")
files_list.append("/home/pi/process_manipulating_functions/burn_cycles/deadline_logger_burn_cycles_around25_1.inc")
files_list.append("/home/pi/process_manipulating_functions/burn_cycles/deadline_logger_burn_cycles_around25_2.inc")
files_list.append("/home/pi/process_manipulating_functions/burn_cycles/deadline_logger_burn_cycles_around25_3.inc")
...
def UpdateShowDistributionPage():
	...
	#print "display:"+str(difference)

        

	font = pygame.font.SysFont("Roboto Condensed", 20)
	text = font.render ("d: "+str(difference), True, (0,0,0))
	...
	#print percentage_val
        ...
        if (difference > deadline):
                deadline_logger_display_local = '1 '+str(percentage_val)
                missed = missed + 1
        else:
                deadline_logger_display_local = '0 '+str(percentage_val)
        total = total + 1 # for display app
        #print deadline_logger_display_local
        ...
        for i in range(0,files_list_len):
                ...
                try:
                        ...
                        if (int_objs[0]=="1"):
                                missed = missed + 1
                        total = total + 1
                        differences_list.append(int(int_objs[1]))
                        #print int_objs
                        file_obj.close()
                except Exception as inst:
                        print inst
	...
	if (difference>deadline):
		...
		text = font.render (str(deadline_missed_percentage)+"%", True, (0, 0, 0))
...
def APP4MCDistributionActions():
        ...
        try:
                with open('coredef_list.a4p','rb') as coredef_list:
