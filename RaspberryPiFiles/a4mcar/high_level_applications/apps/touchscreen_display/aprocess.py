...
class aprocess:
	...
	def __init__ (self, apname, traceable, aplogfilepath, displayed, display_name, apstartcommand):
		self.aid = id #A4MCAR Process ID, unique
		id = id + 1
	...
	def __init__ (self, apname, traceable, displayed, display_name, apstartcommand):
		self.aid = id #A4MCAR Process ID, unique
		id = id + 1
		...
		#Tracing Related Attributes
		self.traceable = traceable # Only traceable processes are considered in timing calculations.
		self.aplogfilepath = "None" #Where the timing log file for this process located, for traceable processes, must be string

		#Display Related Attributes
		self.displayed = displayed  #Flag
		self.display_name = display_name #String display name
